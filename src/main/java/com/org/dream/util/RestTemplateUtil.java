...
public class RestTemplateUtil {
     ...
     * @param reqJsonStrParam the req json str param
     * @return the string
     */
    public static String postJson(String reqUrl, String reqJsonStrParam) {
        ...
        // 执行请求
        ResponseEntity<String> resp = restTemplate.exchange(reqUrl, HttpMethod.POST, requestEntity, String.class);
        // 返回请求返回值
        return resp.getBody();
    }
     ...
     * Post form string.
     * @param reqUrl      the req url
     * @param reqFormPara the req form para
     * @return the string
     */
